    ...
    <div class="content">
        ...
        <div class="main">
            ...
            <div class="order-info">
                <div class="continf">
                    <div class="info-block data-block">
                        <p class="img-continf"></p>
                        <h1 class="text-data">Учётные данные</h1> 
                        
                    </div>
                    <div class="info-block">
                        <div class="info-content">
                            <u class="text"><h4 class="text">ФИО</h4></u>
                            <h3 class="text-2"><?= $client["name"] ?></h3>
                            <p class="otst"><u class="text"><h4 class="text">Дата рождения</h4></u></p>
                            <h3 class="text-2">4 Сентября 2077</h3>
                            <p class="otst"><u class="text"><h4>Адрес</h4></u></p>
                            <h3 class="text-2"><?= $order["addres"] ?></h3>
                            <p class="otst"><a href="#" class="change-button">Изменить</a></p>
                        </div>
                        <div class="info-block-2">
                            <div class="info-content">
                                <u class="text"><h4 class="text">Телефон</h4></u>
                                <h3 class="text-2"><?= $order["phone"] ?></h3>
                                <p class="otst"><u class="text"><h4 class="text">Почта</h4></u></p>
                                <h3 class="text-2"><?= $client["mail"] ?></h3>
                            </div>
                        </div>
                    </div>
                </div>
